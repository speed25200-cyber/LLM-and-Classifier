...
| `tests/` | 103 tests (hors ligne, faux llama-server, Studio de bout en bout, interface et voix pilotees par Chromium, bureau, navigateur Playwright, banc Jev, conforme, integration contre un `llama-server` reel) |
